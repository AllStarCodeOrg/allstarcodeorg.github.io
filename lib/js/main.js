...
$(".q_section").click(function(){
	let section = $(this)
	section.find(".ans").slideToggle("fast");
	section.toggleClass("highlight");
});

//A/B randomizing survey
if(Math.random()>0){
	$("[href*=survey]").attr("href","https://www.surveymonkey.com/r/ASC2018");
}